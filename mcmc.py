...
parser.add_argument('-ds', help = 'seed for simulation', nargs='?', type = int, default = 78041850638968143)
...
# super root related
#parser.add_argument('-gsr', help='gtheta super root branch', nargs='?', default=0.8, type=float)
#parser.add_argument('-ksr', help='kalpha super root branch', nargs='?', default=0.01, type=float)
